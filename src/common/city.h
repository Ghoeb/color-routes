...
struct city_building
{
    ...
    /** Heap con las opciones que tiene este cliente */
    Heap* options;

    /** El indice que tiene este cliente en el heap global */
    size_t* heap_index;

    /** La zona vecina a la cual está conectada este cliente */
    Zone* vecino;

    /** El core por el que está siendo abastecido este cliente */
    // Core* abastecedor;
...
struct city_zone
{
    ...
    /** La cantidad de puertos disponibles para este core */
    // uint8_t avaliable_ports;

    /** Indica el grupo de zonas al que pertenece esta zona */
    size_t group;
